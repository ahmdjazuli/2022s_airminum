...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-primary btn-lg"><a href="user.php" style="color: white; text-decoration: none"> <i class="fa fa-angle-left"></i></a></button> Ubah Data Pelanggan</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
...
<?php
  if (isset($_POST['simpan'])) {
    ...
    $ubah = mysqli_query($kon,"UPDATE user SET nama = '$nama', telp = '$telp', alamat = '$alamat', jk = '$jk' WHERE id = '$id'");
    if($ubah){
