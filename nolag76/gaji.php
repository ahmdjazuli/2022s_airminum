        ...
        <div class="modal-content modal-sm" style="margin:0 auto">
            ...
            <div class="modal-body">
                ...
                <select name="tahun" class="form-control" required>
                  <?php
                    $ahay = mysqli_query($kon, "SELECT DISTINCT YEAR(tgl) as tahun FROM gaji ORDER BY tahun DESC");
                    while($baris = mysqli_fetch_array($ahay)) {
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-primary btn-lg"><a href="gaji_input.php" style="color: white; text-decoration: none">+</a></button> 
                    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal"> <i class="fa fa-print"></i> </button> Gaji Karyawan</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $no=1; $query = mysqli_query($kon, "SELECT *,MONTH(tgl) as bulan,YEAR(tgl) as tahun FROM gaji INNER JOIN user ON gaji.id = user.id ORDER BY tgl DESC");
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a href="gaji_edit.php?idgaji=<?php echo $data['idgaji']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                                <button class="btn btn-primary btn-sm" type="button" onclick="return confirm('Yakin ingin Menghapus?');"><a href="delete.php?idgaji=<?php echo $data['idgaji'] ?>" style="color: white;"><i class="fa fa-trash"></i></a></button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
