...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-primary btn-lg"><a href="masuk_input.php" style="color: white; text-decoration: none">+</a></button> 
                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal"> <i class="fa fa-print"></i> </button> Inventori Masuk </h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                                    ...
                                    <?php $no=1; $query = mysqli_query($kon, "SELECT * FROM inventorimasuk INNER JOIN inventori ON inventorimasuk.idinventori = inventori.idinventori ORDER BY tgl DESC");
                                        while($data = mysqli_fetch_array($query)){ ?>
                                            <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="masuk_edit.php?idinventorimasuk=<?php echo $data['idinventorimasuk']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
