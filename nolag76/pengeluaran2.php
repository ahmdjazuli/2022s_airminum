    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-sm" style="margin:0 auto">
            ...
            <div class="modal-body">
                <form action="../report/laporanPengeluaran.php" target="_blank" method="post">
                    <label>Bulan</label>
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-print"></i></button> Pengeluaran Bulanan</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
