...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-primary btn-lg"><a href="karyawan.php" style="color: white; text-decoration: none"> <i class="fa fa-angle-left"></i></a></button> Tambah Data Karyawan</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
...
<?php
  if (isset($_POST['simpan'])) {
    ...
    $tambah = mysqli_query($kon,"INSERT INTO user(nama,telp,alamat,jk,level,username) VALUES ('$nama','$telp','$alamat','$jk','Karyawan','$username')");
    if($tambah){
