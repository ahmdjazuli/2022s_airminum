...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-primary btn-lg"><a href="repair.php" style="color: white; text-decoration: none"> <i class="fa fa-angle-left"></i></a></button> Tambah Inventori Perbaikan</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
                         ...
                         <form role="form" action="" method="POST">
                            <div class="form-group">
                                ...
                                <select name="idinventorirusak" class="form-control" onchange='ubah(this.value)' required>
                                  ...
                                  <?php
                                    $rendi = mysqli_query($kon, "SELECT * FROM inventorirusak INNER JOIN inventori ON inventorirusak.idinventori = inventori.idinventori WHERE idinventorirusak NOT IN (SELECT idinventorirusak FROM inventorirepair) ORDER BY tglrusak DESC");
