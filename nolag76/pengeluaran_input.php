...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-primary btn-lg"><a href="pengeluaran.php" style="color: white; text-decoration: none"> <i class="fa fa-angle-left"></i></a></button> Data Pengeluaran Lainnya</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
...
<?php
  if (isset($_POST['simpan'])) {
    ...
    $tambah = mysqli_query($kon,"INSERT INTO pengeluaran(tgl,ket,total) VALUES ('$tgl','$ket','$total')");
    if($tambah){
      ?> <script>alert("Berhasil Disimpan");window.location='pengeluaran.php';</script> <?php
    }else{
      ?> <script>alert("Gagal Disimpan");window.location='pengeluaran_input.php';</script> <?php
    }
  }
?>